...
sdl = SimpleDatasetLoader(dataset = DATASET, path = mypath = '/data/' + dataset + '/download/images', species = MAX_SPECIES, grayscale = False, preprocessors=[sp])
...
save_report(report, start_time, end_time, model, MAX_SPECIES, WIDTH, HEIGHT, DATASET)
